...
public class RecruitController {
	...
	public Result findAll(){
		return Result.success(StatusCodeEnum.STATUS_SEARCH_OK,recruitService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return Result.success(StatusCodeEnum.STATUS_SEARCH_OK,recruitService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return Result.success(StatusCodeEnum.STATUS_SEARCH_OK, new PageResult<Recruit>(pageList.getTotalElements(), pageList.getContent()));
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
		return Result.success(StatusCodeEnum.STATUS_SEARCH_OK,recruitService.findSearch(searchMap));
    }
